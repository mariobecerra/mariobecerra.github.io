...
The following examples were taken from the course taught by [Felipe González](felipegonzalez.github.io) at [ITAM](https://www.itam.mx/en). They show how the code can approximate non-linear functions quite accurately.
...
```{r}
ann_1 <- ann_rcpp(as.matrix(dat_1$x_1), dat_1$y, q = 4, alpha = 0.3, n_iter = 15000, seed = 2018)
#plot_convergence(ann_1)
