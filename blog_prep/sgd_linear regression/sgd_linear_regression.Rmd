...
lm_minibatch <- function(X, y, minibatch_size = 15, 
  ...
  while(i < max_it){
    ...
    if(g_norm < 1e-8 | dif_betas_norm < 1e-8) break
  }
...
plot_minibatches_2_params <- function(data_minibatch, beta_0, beta_1, coef_1, coef_2){
...
data_minibatch_1_100 <- lm_minibatch(X, y, 100, initial_point = c(-100, 100))

plot_minibatches_2_params(data_minibatch_1_1, beta_0, beta_1, model$coefficients[1], model$coefficients[2])
plot_minibatches_2_params(data_minibatch_1_2, beta_0, beta_1, model$coefficients[1], model$coefficients[2])
plot_minibatches_2_params(data_minibatch_1_13, beta_0, beta_1, model$coefficients[1], model$coefficients[2])
plot_minibatches_2_params(data_minibatch_1_15, beta_0, beta_1, model$coefficients[1], model$coefficients[2])
plot_minibatches_2_params(data_minibatch_1_100, beta_0, beta_1, model$coefficients[1], model$coefficients[2])


data2 <- tibble(x = rnorm(1000009),
               y = beta_0 + beta_1*x + rnorm(1000009))


data_minibatch_2_100 <- lm_minibatch(data2$x, data2$y, 100, initial_point = c(-10, -10))
# data_minibatch_2_all <- lm_minibatch(data2$x, data2$y, nrow(data2), initial_point = c(-10, -10))
...
plot_minibatches_2_params(data_minibatch_2_100, beta_0, beta_1, model$coefficients[1], model$coefficients[2])
...
data_minibatch_3_100 <- lm_minibatch(data_3[,1:2], data_3$y, 100, initial_point = c(-10, -10, 0))
...
data_minibatch_4_100 <- lm_minibatch(data_4[,1:3], data_4$y, 100, initial_point = c(-10, -10, 0, 0))
...
data_minibatch_diamonds_100 <- lm_minibatch(data_diamonds[,1:9], data_diamonds$y, minibatch_size = 100)
betas_diamonds <- as.numeric(data_minibatch_diamonds_100[nrow(data_minibatch_diamonds_100), grepl("beta", names(data_minibatch_diamonds_100))])
