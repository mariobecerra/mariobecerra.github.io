...
Analyzed data for the marketing and CRM teams of the bank. Projects included:
...
- Optimized a Bayesian hierarchical model for BTYD analysis suited for large scale data analysis.
